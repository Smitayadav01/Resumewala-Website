      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            {/* LEFT — Content */}
            <div>
              <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-700 rounded-full px-4 py-1.5 text-sm font-semibold mb-5">
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-8 max-w-lg">
                Most resumes get rejected by ATS software before a recruiter ever sees them.
                Our experts rewrite your resume to be recruiter-ready and ATS-friendly —
                built for freshers and early-career candidates.
              </p>

              <div className="space-y-3 mb-8">
                {[
                  "ATS-optimised, professionally written resume",
                  "Tailored to your target job role",
                  "Delivered within 36–48 hours",
                ].map((point) => (
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-4 rounded-xl text-base transition shadow-lg shadow-blue-600/20 w-full sm:w-auto"
                >
                  Get My Resume Fixed
                  <ArrowRight className="h-4 w-4" />
                </button>
                <p className="text-sm text-gray-500">
                  Starting at <span className="font-bold text-gray-900">₹99</span> · No subscription needed
                </p>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl p-8 sm:p-10 shadow-xl">
                <div className="flex items-center justify-between mb-8">
                  <span className="text-blue-100 text-sm font-medium">Fresher / Early-Career Resume</span>
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 space-y-3 mb-6">
                  {[
                    "ATS-friendly formatting",
                    "Keyword-optimised for your role",
                ...
                <button
                  onClick={() => navigate('/resume-services')}
                  className="w-full bg-white text-blue-700 font-semibold py-3.5 rounded-xl text-sm hover:bg-blue-50 transition"
                >
                  Order Now — ₹99
                </button>
              </div>
              ...
              {/* Floating stat badge */}
              {/* <div className="absolute -bottom-5 -left-5 sm:-left-8 bg-white rounded-2xl shadow-xl border border-gray-100 px-5 py-4 hidden sm:block">
